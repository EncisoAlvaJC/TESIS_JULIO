...
Por simplicidad, en el presente texto únicamente se manejan espacios de probabilidad de la forma $(I,\mathcal{B}_I,P)$, con $I\subseteq \R$ un intervalo.
...
Se dice que una medida de probabilidad, $P$, es \textbf{discreta} si $P\left(\mathcal{D}_P\right)=1$.
